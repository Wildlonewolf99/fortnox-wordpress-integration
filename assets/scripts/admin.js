;(function ($) {
    $(function () {
        ...
        $('.syncOrderToFortnox').on('click', function (event) {
            ...
            var status = $(this).siblings('.wallspace-fortnox-status');
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (!response.error)
                        status.removeClass('wallspace-icon-cross').addClass('wallspace-icon-check');
                    ...
                    $('.sendInvoiceToCustomer[data-order-id=' + orderId + ']').removeClass("wallspace-hidden");
        ...
        $('.sendInvoiceToCustomer').on('click', function (event) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('.sendInvoiceToCustomer[data-order-id=' + orderId + ']').addClass("wallspace-hidden");
